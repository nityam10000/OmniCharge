...
public class OperatorServiceImpl implements IOperatorService {
    ...
    public OperatorResponseDTO getOper(long id) {
        ...
        OperatorEntity entity = operatorRepo.findById(id)
                .orElseThrow(() -> {
                    ...
                    return new ResourceNotFoundException("Operator not found with id: " + id);
                });
    ...
    public Page<OperatorResponseDTO> getOperList(Pageable pageable) {
        log.info("Fetching operators with pagination: page={}, size={}", pageable.getPageNumber(), pageable.getPageSize());
        Page<OperatorEntity> operatorPage = operatorRepo.findAll(pageable);
        Page<OperatorResponseDTO> responsePage = operatorPage.map(this::mapToResponse);
        log.info("Successfully retrieved {} operators", responsePage.getNumberOfElements());
        return responsePage;
    }
    ...
    private OperatorResponseDTO mapToResponse(OperatorEntity entity) {
        return mapper.operatotToDTO(entity);
    }
}