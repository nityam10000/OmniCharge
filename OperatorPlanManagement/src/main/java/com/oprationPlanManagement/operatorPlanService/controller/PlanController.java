...
public class PlanController {
    ...
    public ResponseEntity<Page<PlanResponseDTO>> getAllPlansPaginated(Pageable pageable) {
        return ResponseEntity.ok(planService.getPlanList(pageable));
    }

    @GetMapping("/operator/{operatorId}")
    public ResponseEntity<List<PlanResponseDTO>> getPlansByOperatorId(@PathVariable Long operatorId) {
        return ResponseEntity.ok(planService.getPlansByOperatorId(operatorId));
    }
